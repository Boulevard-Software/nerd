...
The `NERD` dashboard is used for training [Apache OpenNLP](https://opennlp.apache.org/) models, crawling websites and processing results. Turning web pages into data for export to database or [Apache Solr](http://lucene.apache.org/solr/).
